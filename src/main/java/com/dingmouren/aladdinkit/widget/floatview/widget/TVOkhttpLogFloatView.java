...
public class TVOkhttpLogFloatView extends AbsFloatView {
    ...
    public void initLayoutParams(FrameLayout.LayoutParams params) {
        ...
        params.leftMargin = screenWidth/3*2;
    ...
    public void onMove(int x, int y, int dx, int dy, boolean initPosition) {
        ...
        int yMax = screenHeight - SizeUtils.dp2px(60);
    ...
    private void showIconLayout() {
        ...
        mLayoutParams.width = SizeUtils.dp2px(60);
        mLayoutParams.height = SizeUtils.dp2px(60);
